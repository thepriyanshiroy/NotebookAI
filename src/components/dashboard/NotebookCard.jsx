...
const getColorObj = (hex) => COLORS.find((c) => c.primary === hex) || COLORS[0];
...
export default function NotebookCard({ notebook, onDelete }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{
            ...
            fontSize: icon.length <= 2 ? "15px" : "28px",
            fontWeight: 800,
            color: c.primary,
      ...
      <p style={{ color: "rgba(150,200,255,0.4)", fontSize: "14px", marginBottom: "24px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "18px" }}>
        <div>
          ...
          <p style={{ color: "rgba(150,200,255,0.35)", fontSize: "12px", marginTop: "3px" }}>
            Sections
          </p>
        </div>
        <div
